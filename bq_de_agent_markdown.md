...
when we run the pipeline generated by the agent, table `actual_sales_step1` will be created under `final_layer` dataset
...
when we run the pipeline generated by the agent, table `actual_sales_step2` will be created under `final_layer` dataset
...
when we run the pipeline generated by the agent, table `actual_sales_step3` will be created under `final_layer` dataset
